package Estructura_De_Datos.Unidad6;
import java.util.Scanner;

public class MainBusqueda {
    public static void main(String[] args) {
         MainBusqueda orden = new MainBusqueda();
        orden.menu();
    }
    public void menu(){
        ...
        do {
            ...
            if (op < 14){
                switch (op){
                    ...
                    case 11: ord.Secuencial();break;
                    case 12: ord.Binaria();break;
                    case 13: break;
                }
            }else {
...
class Lista {
    ...
    void Secuencial(){
        System.out.print("Numero que desea buscar: "); dato = en.nextInt();
        secuencial(arreglo,dato);
        System.out.println();
    }
    ...
    * */
    ...
    void secuencial(int arr[], int valor) {
        boolean  exist=false;
    ...
    * */
    void Binaria(){
        int inicio, fin, mit = 0,vcentral = 0;
        ...
        if(!esVacia()){
            ...
            while (inicio <= fin){
                mit = (inicio + fin) / 2;
                vcentral = arreglo[mit];
                if (vcentral == dato){
                    encontrao = true;
                    break;
                } else if (vcentral > dato){
                    fin = mit - 1;
                }else if (vcentral < dato){
                    inicio = mit + 1;
                }
            ...
            mosArreglo();
            if (encontrao == true){
                System.out.println("El valor ha sido encontrado en la posicion " + mit);
            }else {
